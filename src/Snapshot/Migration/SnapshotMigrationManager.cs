...
/// <list type="bullet">
/// <item><description>Detects snapshot version from XML data</description></item>
/// <item><description>Applies sequential migrations to reach target version</description></item>
/// <item><description>Supports custom migrators via registration</description></item>
/// <item><description>Validates migration paths for compatibility</description></item>
/// </list>
/// <para>
...
public sealed class SnapshotMigrationManager
{
    ...
    public WorldSnapshotXml MigrateToLatest(WorldSnapshotXml snapshot)
    {
        ...
        if (!SnapshotMigrationManager.RequiresMigration(snapshot))
            return snapshot;
    ...
    public IReadOnlyList<ISnapshotMigrator> GetRegisteredMigrators() => _migrators.AsReadOnly();
}