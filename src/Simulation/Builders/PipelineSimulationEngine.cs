...
/// <summary>
/// Enhanced simulation engine using a modern pipeline architecture for extensibility and modularity.
...
public sealed class PipelineSimulationEngine
{
    ...
    public PipelineSimulationEngine(
        World world,
    ...
    /// <summary>
    /// Initializes a new instance of the PipelineSimulationEngine class with a custom pipeline.
    /// </summary>
    /// <param name="world">The world to simulate.</param>
    /// <param name="configuration">The simulation configuration.</param>
